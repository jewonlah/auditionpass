...
export const AUDITION_LIST_COLUMNS =
  "id,title,company,genre,category,deadline,description,requirements,source_url,source_name,apply_type,is_active,application_ready,oneclick_blocked,reports_count,review_status,crawled_at,created_at";
