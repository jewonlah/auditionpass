...
| 스킬 | 요청 에이전트 | 용도 | 상태 |
|---|---|---|---|
| Canva MCP | 디자인 | 프로급 카드 디자인 | 대기 |
| Instagram Automation | 마케팅 | 자동 포스팅 | 대기 |
| Brand Guidelines | 디자인 | 브랜드 일관성 | 대기 |
| Replicate MCP | 디자인 | AI 이미지 생성 | 대기 |
| Social Content Strategy | 마케팅 | 콘텐츠 전략 | 대기 |
